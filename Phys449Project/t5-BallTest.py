...
def cheeseHole(x, y, z, r, lc, shells, layer):
    ...
    model.addPhysicalGroup(2, [s1, s2, s3, s4, s5, s6, s7, s8], layer)
    #model.setPhysicalName(2,layer,"Shell" + str(layer))
...
for layer in range(layers):
    r += 0.1
    v = cheeseHole(x, y, z, r, lcar3, shells, layer)
    model.addPhysicalGroup(3, [v], layer)
