...
Ao = D2*pi/2;
Cg = Ai/Ao;
absorber_efficiency = 0.8455; %From ray-tracing simulation
...
plot_trough = true;
verbose = false;
[L, Tf_store, Qdot_trough_store, rec_eff_store] = get_trough_performance(Ti,To,mdot_opt,L,dL,QdotS,cpf,rhof,D2,alpha_e,ve,ke,Be,Te,eps_a,eps_s,verbose,plot_trough);
...
for i=1:Nm
    ...
    plot_trough = false;
    [L, Tf, Qdot_trough, rec_eff] = get_trough_performance(Ti,To,mdot,L,dL,QdotS,cpf,rhof,D2,alpha_e,ve,ke,Be,Te,eps_a,eps_s,verbose,plot_trough);
